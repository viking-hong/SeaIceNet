...
writer = SummaryWriter('./seaicenet/')
...
class Supervision_Train(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        writer.add_scalar('val_ThinIce', iou_value['ThinIce'], self.epoch_idx)
        writer.add_scalar('val_ThickIce', iou_value['ThickIce'], self.epoch_idx)
        writer.add_scalar('val_Sea', iou_value['Sea'], self.epoch_idx)
        writer.add_scalar('val_Land', iou_value['Land'], self.epoch_idx)
        writer.add_scalar('val_PoolIce', iou_value['PoolIce'], self.epoch_idx)
